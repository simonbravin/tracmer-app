...
export const APP_MODULES = [
  ...
  { code: "treasury_transactions", displayName: "Tesorería · Transacciones" },
  { code: "treasury_locations", displayName: "Tesorería · Ubicaciones" },
...
export const MODULE_ACTIONS: Record<AppModuleCode, readonly string[]> = {
  ...
  treasury_transactions: ["view", "create", "edit", "archive"],
  treasury_locations: ["view", "create", "edit"],
